...
//  Content
 ...
 $display_card_background_color = get_sub_field('display_card_background_color');

?>

<section class="py-8 px-4 bg-white bg-center bg-no-repeat bg-cover"
    style="background-image: url(<?php echo get_sub_field('display_background_image') ? get_template_directory_uri() . "/resources/svg/***.svg" : " "; ?>">
    <div class="container p-0 mx-auto">
        <h3 class="text-center text-primary mb-20 leading-10 text-[35px] xl:text-[48px] px-4">
            <?php echo get_sub_field('title'); ?>
        </h3>

        <div class="grid_content grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            <div class="flex flex-col items-center justify-between px-4 <?php echo get_sub_field('title'); ?>">
                ...
                <div class="<?php echo $display_button_link ? "block button" : "hidden"; ?>">
                    <a class="px-4 py-2 text-white bg-primary hover:bg-secondary transition-all duration-200 ease-in-out"
