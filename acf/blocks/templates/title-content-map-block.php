...
<section class="title_content_map <?php echo $background_color ?>">
    <div class="flex <?php echo $display_content_option == "Right" ? "flex-col-reverse" : "flex-col" ?> gap-y-4 gap-x-16 p-0 mx-auto lg:flex-row">
        <div class="map <?php echo $display_content_option == "Right" ? "w-full lg:w-1/2 min-h-[500px]" : "hidden" ?>">
        ...
        <div class="map <?php echo $display_content_option == "Left" ? "w-full lg:w-1/2 min-h-[500px]" : "hidden" ?>">
            <?php echo get_field('map') ?>
        </div>
    </div>
</section>