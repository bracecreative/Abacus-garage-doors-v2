...
<section class="lg:px-4 py-8 <?php echo $background_color ?>">
    <div class="container flex <?php echo $display_content_option == "Right" ? "flex-col-reverse" : "flex-col" ?> gap-4 p-0 mx-auto lg:flex-row">
        ...
        <div class="flex flex-col items-center w-full px-4 <?php echo $display_content_option == "Left" ? "lg:items-end" : "lg:items-start"?> lg:px-8 lg:w-1/2">
